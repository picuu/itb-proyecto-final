...
<template>
      ...
      <AdvertListItem v-for="offer in offers" :title="offer.title" :description="offer.description" :image="offer.image" :id="offer.id" :isRequest="offer.isRequest" :key="offer.id">
